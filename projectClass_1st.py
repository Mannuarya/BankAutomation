...
header_date = Label(win, text='', font=('arial', 15, 'bold'), bg='red4',fg='darkgoldenrod2')
header_date.place(relx=.12,rely=.1)

header_time = Label(win, text='', font=('arial', 15, 'bold'), bg='red4',fg='darkgoldenrod2')
...
footer_title=Label(win,text='Project Guide : Mr. Aditya Kumar',font=('arial', 15, 'bold'),fg='floralwhite',bg='red4')
footer_title.pack(side='bottom')
footer_title=Label(win,text='Email : mannuarya2002@gmail.com',font=('arial', 15, 'bold'),fg='#33A1C9', bg='red4')
footer_title.pack(side='bottom')
footer_title=Label(win,text='Developed by: Manish Arya',font=('arial', 15, 'bold'),fg='floralwhite', bg='red4')
footer_title.pack(side='bottom')
...
def main_screen():      #function
    ...
    def Exit():
        ...
        if resp:                #default boolean value is always true
            win.destroy()
    ...
    def gen_captcha():
        global cap
        cap = ''.join(random.choices(string.ascii_uppercase + string.ascii_lowercase + string.digits, k=6)) # Generates a random 6-character captcha
        return cap
    ...
    def login_click():
        ...
        try:
            ...
            uacn=int(uacn)
            if uacn==1 and upass=='a' and urole=='Admin':
                frm.destroy()
                Admin_win()
            elif urole=='User':
    ...
    def refresh_captcha():
        ...
        gen_captcha_Lab.config(text='')        # Clear the old captcha by setting text to an empty string
        gen_captcha_Lab.destroy()
        new_captcha = gen_captcha()            # Generate new captcha and update the label
        gen_captcha_Lab = Label(frm, text=new_captcha, relief='flat', font=('arial', 15, 'bold'),bg='floralwhite', fg='green')
        gen_captcha_Lab.place(relx=.48, rely=.58)

       
    #   CAPTCHA LABEL                           ===================================================================
    global gen_captcha_Lab
    gen_captcha_Lab=Label(frm,text=gen_captcha(),relief='flat',font=('arial',15,'bold'),bg='white',fg='green')
    gen_captcha_Lab.place(relx=.48,rely=.58)

    #   CAPTCHA refresh button image     
    ...
    refresh_btn.place(relx=.55, rely=.58)
