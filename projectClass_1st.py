from tkinter import Tk, Label,Frame,Entry,Button,messagebox,simpledialog,StringVar,filedialog
...
def main_screen():      #function
    ...
    acnt_label=Label(frm,text='Accnt.no.',relief='flat',font=('arial',20,'bold'),bg='floralwhite',fg='red4')
    acnt_label.place(relx=.3,rely=.2)
    acnt_entry=Entry(frm,font=('arial',20,'bold'),bd=5,relief='flat')
    acnt_entry.place(relx=.45,rely=.2)
    acnt_entry.focus()


    pass_label=Label(frm,text='Pass',relief='flat',font=('arial',20,'bold'),bg='floralwhite',fg='red4')
    pass_label.place(relx=.3,rely=.3)
    pass_entry=Entry(frm,font=('arial',20,'bold'),bd=5,show='*',relief='flat')
    pass_entry.place(relx=.45,rely=.3)

    role_label=Label(frm,text='Role',relief='flat',font=('arial',20,'bold'),bg='floralwhite',fg='red4')
    role_label.place(relx=.3,rely=.4)
    role_cb=Combobox(frm,font=('arial',20,'bold'),values=['User','Admin'],state='readonly',cursor='hand2',height=5)      #combo box  ========================================
    role_cb.current(0)
    role_cb.place(relx=.45,rely=.4)
    ...
    #buttons                                                                    ===================================================================
    gen_captcha_Lab=Label(frm,text=gen_captcha(),relief='flat',font=('arial',20,'bold'),bg='white',fg='green')
    gen_captcha_Lab.place(relx=.45,rely=.52)

    Captcha_Lab=Label(frm,text='Captcha',relief='flat',font=('arial',20,'bold'),bg='floralwhite',fg='red4')
    Captcha_Lab.place(relx=.3,rely=.65)
    captcha_entry=Entry(frm,font=('arial',20,'bold'),bd=5,relief='flat')
...
def Admin_win():
    ...
    def create_click():
        ...
        user_name_label=Label(current_child_frm,text='Name',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        user_name_label.place(relx=.1,rely=.1)
        user_name_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=3,relief='flat')
        user_name_entry.place(relx=.1,rely=.2)
        user_name_entry.focus()

        user_email_label=Label(current_child_frm,text='Email',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        user_email_label.place(relx=.6,rely=.1)
        user_email_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=3,relief='flat')
        user_email_entry.place(relx=.6,rely=.2)

        user_mob_label=Label(current_child_frm,text='Mobile',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        user_mob_label.place(relx=.1,rely=.3)
        user_mob_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=3,relief='flat')
        user_mob_entry.place(relx=.1,rely=.4)

        user_adhar_label=Label(current_child_frm,text='Aadhaar',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        user_adhar_label.place(relx=.6,rely=.3)
        user_adhar_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=3,relief='flat')
    ...
    def View_click():
        ...
        search_entry = Entry(current_child_frm, textvariable=search_var, font=('Arial', 12))
    ...
    def Delete_click():
        ...
        delete_acnt_label=Label(current_child_frm,text='Account.No.',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        delete_acnt_label.place(relx=.41,rely=.2)
        delete_acnt_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=5,relief='flat')
    ...
    admn_label=Label(admn_frm,text='Welcome,Admin',relief='flat',font=('arial',10,'bold'),bg='floralwhite',fg='red4')
    admn_label.place(relx=0,rely=0)
    #logout button                                                               ========================================================                                                           
    logout_btn=Button(admn_frm,text='Logout',relief='raised',width=10,font=('arial',15,'bold'),bd=5,bg='red4',fg='floralwhite',command=AdminLgout_click)
...
def forgot_pass_win():
    ...
    frgt_acnt_label=Label(frgt_frm,text='Accnt.no.',relief='flat',font=('arial',20,'bold'),bg='floralwhite',fg='red4')
    frgt_acnt_label.place(relx=.3,rely=.2)
    frgt_acnt_entry=Entry(frgt_frm,font=('arial',20,'bold'),bd=5,relief='flat')
    frgt_acnt_entry.place(relx=.45,rely=.2)
    frgt_acnt_entry.focus()


    frgt_email_label=Label(frgt_frm,text='Email',relief='flat',font=('arial',20,'bold'),bg='floralwhite',fg='red4')
    frgt_email_label.place(relx=.3,rely=.3)
    frgt_email_entry=Entry(frgt_frm,font=('arial',20,'bold'),bd=5,show='*',relief='flat')
    frgt_email_entry.place(relx=.45,rely=.3)

    frgt_mob_label=Label(frgt_frm,text='Mob.',relief='flat',font=('arial',20,'bold'),bg='floralwhite',fg='red4')
    frgt_mob_label.place(relx=.3,rely=.4)
    frgt_mob_entry=Entry(frgt_frm,font=('arial',20,'bold'),bd=5,show='*',relief='flat')
    frgt_mob_entry.place(relx=.45,rely=.4)

    submit_btn=Button(frgt_frm,command=get_password,text='submit',relief='raised',font=('arial',15,'bold'),bd=5,bg='red4',fg='floralwhite',cursor='hand2')
    submit_btn.place(relx=.5,rely=.55)

    reset_btn=Button(frgt_frm,command=RESET,text='Reset',relief='raised',font=('arial',15,'bold'),bd=5,bg='red4',fg='floralwhite',cursor='hand2')
    reset_btn.place(relx=.62,rely=.55)
...
def User_win():
    ...
    uplaod_prfl=Button(user_frm,command=update_Profile_img,text='Upload Profile',font=('arial',10),bd=5,bg='floralwhite',fg='red4')
    ...
    def check_bal():
        ...
        check_Bal_title_label=Label(current_child_frm,text='Check-Balance',relief='flat',font=('arial',10,'bold'),bg='red4',fg='floralwhite')
        ...
        check_Bal_acnt_label=Label(chk_dtl_frm,text='Account.No.',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        check_Bal_acnt_label.grid(row=0,column=0)
        check_Bal_acnt_label=Label(chk_dtl_frm,text=uacn,relief='flat',font=('arial',15,'bold'),bd=5,bg='red4',fg='green2')
        check_Bal_acnt_label.grid(row=0,column=1)

        check_Bal_label=Label(chk_dtl_frm,text='Balance',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        check_Bal_label.grid(row=1,column=0)
        check_Bal_label=Label(chk_dtl_frm,text=f'₹ {tup[0]}',relief='flat',font=('arial',15,'bold'),bd=5,bg='red4',fg='green2')
        check_Bal_label.grid(row=1,column=1)

        check_open_date_label=Label(chk_dtl_frm,text='Open Date',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        check_open_date_label.grid(row=3,column=0)
        check_open_date_label=Label(chk_dtl_frm,text=f'{tup[1]}',relief='flat',font=('arial',15,'bold'),bd=5,bg='red4',fg='green2')
        check_open_date_label.grid(row=3,column=1)

        check_ifsc_label=Label(chk_dtl_frm,text='Aadhar',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        check_ifsc_label.grid(row=4,column=0)
        check_ifsc_label=Label(chk_dtl_frm,text=f'{tup[2]}',relief='flat',font=('arial',15,'bold'),bd=5,bg='red4',fg='green2')
    ...
    def update_details():
        ...
        def updt_dtail_btn():
            ...
            con_obj=sqlite3.connect(database='BankDetails.sqlite')
            cur_obj=con_obj.cursor()
            cur_obj.execute('select * from users where users_acno=? and users_pass=? and users_email=? and users_mob=? and users_name=?',(uacn,upass,uemail,umob,uname))
            tup=cur_obj.fetchone()
            con_obj.close()
            try:
                gmail_con=gmail.GMail('mannuarya2002@gmail.com','zrth fyvp pywf lkee')
        ...
        updt_name_label=Label(current_child_frm,text='Name',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        updt_name_label.place(relx=.1,rely=.1)
        updt_name_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=3,relief='flat')
        updt_name_entry.place(relx=.1,rely=.2)
        updt_name_entry.insert(0,tup[2])
        updt_name_entry.focus()

        updt_email_label=Label(current_child_frm,text='Email',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        updt_email_label.place(relx=.6,rely=.1)
        updt_email_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=3,relief='flat')
        updt_email_entry.place(relx=.6,rely=.2)
        updt_email_entry.insert(0,tup[4])

        updt_mob_label=Label(current_child_frm,text='Mobile',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        updt_mob_label.place(relx=.1,rely=.3)
        updt_mob_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=3,relief='flat')
        updt_mob_entry.place(relx=.1,rely=.4)
        updt_mob_entry.insert(0,tup[3])

        updt_pass_label=Label(current_child_frm,text='Pass',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        updt_pass_label.place(relx=.6,rely=.3)
        updt_pass_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=3,relief='flat')
    ...
    def Deposite():
        ...
        depst_label=Label(current_child_frm,text='Amount',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        depst_label.place(relx=.26,rely=.35)
        depst_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=5,relief='flat')
    ...
    def withdraw():
        ...
        withdraw_title_label=Label(current_child_frm,text='Withdraw',relief='flat',font=('arial',10,'bold'),bg='red4',fg='floralwhite')
        withdraw_title_label.pack()

        def withdraw_bal():
            uamt=float(wthdrw_entry.get().strip())
        ...
        wthdrw_label=Label(current_child_frm,text='Amount',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        wthdrw_label.place(relx=.26,rely=.35)
        wthdrw_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=5,relief='flat')
    ...
    def transfer():
        ...
        def trnsfr_bal():
            uamt=float(trnsfer_amnt_entry.get().strip())
            toacn=int(trnsfer_to_entry.get().strip())
        ...
        trnsfer_to_label=Label(current_child_frm,text='To Acnt.',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        trnsfer_to_label.place(relx=.26,rely=.25)
        trnsfer_to_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=5,relief='flat')
        trnsfer_to_entry.place(relx=.43,rely=.25)
        trnsfer_to_entry.focus()

        trnsfer_amnt_label=Label(current_child_frm,text='Amount',relief='flat',font=('arial',15,'bold'),bg='red4',fg='floralwhite')
        trnsfer_amnt_label.place(relx=.26,rely=.45)
        trnsfer_amnt_entry=Entry(current_child_frm,font=('arial',15,'bold'),bd=5,relief='flat')
    ...
    def transection():
        ...
        transection_title_label=Label(current_child_frm,text='Transection-History',relief='flat',font=('arial',10,'bold'),bg='red4',fg='floralwhite')
    ...
    user_label=Label(user_frm,text=f'Welcome,{uname}',relief='flat',font=('arial',10,'bold'),bg='floralwhite',fg='red4')
