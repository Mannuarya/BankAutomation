...
def User_win():
    ...
    def check_bal():
        ...
        check_Bal_acnt_label=Label(chk_dtl_frm,text=uacn,font=('arial',15,'bold'),bd=5,bg='red4',fg='green2')
        ...
        check_Bal_label=Label(chk_dtl_frm,text=f'₹ {tup[0]}',font=('arial',15,'bold'),bd=5,bg='red4',fg='green2')
        ...
        check_open_date_label=Label(chk_dtl_frm,text=f'{tup[1]}',font=('arial',15,'bold'),bd=5,bg='red4',fg='green2')
        ...
        check_ifsc_label=Label(chk_dtl_frm,text=f'{tup[2]}',font=('arial',15,'bold'),bd=5,bg='red4',fg='green2')
